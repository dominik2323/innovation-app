module.exports = {
  cs: {
    auth_login_success_header: 'Nyní jste byli zaregistrováni',
    auth_login_success_perex:
      'Pro ověření Vašeho účtu a přihlášení je nutné ve Vaší e-mailové schránce potrdit odkaz, který Vám byl právě zaslán.',
    auth_login_success_resend_email: 'Znovu poslat potrvzovací odkaz.',
  ...
  de: {
    auth_login_success_header: 'Sie wurden jetzt registriert',
    auth_login_success_perex:
      'Um Ihr Konto zu überprüfen und sich anzumelden, müssen Sie den Link, der Ihnen gerade gesendet wurde, in Ihrer E-Mail-Box bestätigen.',

    about_header: 'Über ŠKODA AUTO Logistics',
    auth_login_success_resend_email: 'Bestätigungslink erneut senden.',
    auth_change_password_header: 'Neues Passwort erstellen',
    auth_change_password_page_title: 'Passwort ändern',
    auth_change_password_perex:
    ...
    auth_change_password_success_header:
      'Ihr Passwort wurde erfolgreich geändert',
    auth_change_password_success_perex:
      'Sie können sich jetzt mit dem neuen Passwort anmelden.',
    auth_email_blocked_account_disclaimer:
      'Wenn Sie diese E-Mail ohne Ihr Wissen erhalten haben, kontaktieren Sie uns bitte.',
    auth_email_blocked_account_header: 'Ihr Konto wurde gesperrt',
    auth_email_blocked_account_instructions:
      'Klicken Sie auf den folgenden Link, um Ihr Konto wieder zu aktivieren.',
    auth_email_blocked_account_subject: 'Ihr Konto wurde gesperrt',
    auth_email_change_password_disclaimer:
      'Wenn Sie diese E-Mail ohne Ihr Wissen erhalten haben, kontaktieren Sie uns bitte.',
    auth_email_change_password_header: 'Passwort ändern',
    auth_email_change_password_instructions:
      'Klicken Sie auf den Link, um ein neues Passwort für Ihr Konto festzulegen.',
    auth_email_change_password_subject: 'Passwort ändern',
    auth_email_verification_disclaimer:
      'Wenn Sie diese E-Mail ohne Ihr Wissen erhalten haben, kontaktieren Sie uns bitte.',
    auth_email_verification_header: 'Bitte überprüfen Sie Ihre E-Mail-Adresse',
    auth_email_verification_instructions:
      'Danke für die Registrierung. Überprüfen Sie Ihre E-Mail-Adresse, indem Sie auf die Schaltfläche unten klicken. ',
    auth_email_verification_loading_header: 'Überprüfen Ihrer E-Mail ...',
    auth_email_verification_page_title: 'Überprüfen Sie Ihre E-Mail',
    auth_email_verification_subject: 'Überprüfen Sie Ihre E-Mail-Adresse',
    auth_email_verification_success_header:
    ...
    auth_error_invalid_company: 'Bitte überprüfen Sie den Firmennamen',
    auth_error_invalid_user_password:
      'Ungültige E-Mail oder ungültiges Passwort.',
    auth_error_no_name: 'Hast du vergessen, deinen Namen einzugeben?',
    auth_error_user_already_exists: 'Benutzer existiert bereits',
    auth_error_password_lowercase:
    ...
    auth_error_too_many_attempts:
      'Zu viele Anmeldeversuche. Wir haben Anweisungen zum Weiterleiten Ihrer E-Mail gesendet. ',
    auth_error_too_many_logins: 'Zu viele Anmeldungen in kurzer Zeit.',
    auth_error_unauthorized:
      'Ihr Konto wurde gesperrt. Wir haben Anweisungen zum Weiterleiten Ihrer E-Mail gesendet. ',
    auth_field_email: 'Email',
    auth_field_name: 'Vor- und Nachname',
    auth_field_password: 'Passwort',
    auth_field_password_again: 'Passwort noch einmal',
    auth_field_company: 'Telefon',
    auth_login_cta: 'Noch kein Konto? Anmelden.',
    auth_login_forgot_password: 'Passwort vergessen?',
    auth_login_header: 'Anmelden bei Ihrem Konto',
    auth_login_page_title: 'Login',
    auth_login_perex:
    ...
    auth_signup_gdpr:
      'Mit Ihrer Registrierung stimmen Sie der Datenschutzerklärung und den Datenschutzbestimmungen zu.',
    auth_signup_header: 'Registrieren',
    ...
    contact_garant_of_project: 'Garant-Projekt',
    contact_to_authors: 'Kontakt zu Autoren',
    contents: 'Inhalt',
    contents_about_link: 'Über ŠKODA AUTO Logistics',
    login: 'Einloggen',
    logout: 'Log out',
    navbar_download_label: 'PDF Herunterladen',
    navbar_search_label: 'Suche',
    navbar_search_no_results: 'keine Ergebnisse',
    navbar_search_num_of_results: 'Anzahl von Ergebnissen',
    navbar_search_results: 'Suchergebnisse',
    navbar_share_label: 'Teilen',
    navbar_share_link_copied: 'Link kopiert in Box',
    password: 'Passwort',
    photos: 'Foto',
    sidebar_about_innovation: 'Über Innovation',
    sidebar_benefits: 'Leistungen',
    sidebar_download_label: 'Herunterladen',
    sidebar_motivation: 'Motivation',
    unauthorized: 'Váš účet ještě nebyl schválený.',
  },
  en: {
    auth_login_success_header: 'You have now been registered',
    auth_login_success_perex:
      'To verify your account and login, it is necessary to confirm the link that has just been sent to you in your e-mail box.',

    about_header: 'About ŠKODA AUTO Logistics',
    auth_login_success_resend_email: 'Resend confirmation link.',
    auth_change_password_header: 'Create a new password',
    auth_change_password_page_title: 'Change Password',
    auth_change_password_perex:
      'The password should be at least 8 characters long and contain at least one uppercase letter, one number and one special character.',
    auth_change_password_success_header:
      'Your password was changed successfully',
    auth_change_password_success_perex:
      'You can now log in with the new password.',
    auth_email_blocked_account_disclaimer:
      'If you received this email without your knowledge, please contact us.',
    auth_email_blocked_account_header: 'Your account has been blocked',
    auth_email_blocked_account_instructions:
      'Click on the following link to reactivate your account.',
    auth_email_blocked_account_subject: 'Your account has been blocked',
    auth_email_change_password_disclaimer:
      'If you received this email without your knowledge, please contact us.',
    auth_email_change_password_header: 'Change your password',
    auth_email_change_password_instructions:
      'Click on the link to set a new password for your account.',
    auth_email_change_password_subject: 'Change your password',
    auth_email_verification_disclaimer:
      'If you received this email without your knowledge, please contact us.',
    auth_email_verification_header: 'Please verify your email address',
    auth_email_verification_instructions:
      'Thank you for registering. Verify your email address by clicking the button below. ',
    auth_email_verification_loading_header: 'Verifying your email ...',
    auth_email_verification_page_title: 'Verify your email',
    auth_email_verification_subject: 'Verify your email address',
    auth_email_verification_success_header:
      'We have successfully verified your email',
    auth_email_verification_success_perex:
      "We will further approve your account to gain access to all site content. We'll let you know by email when everything is ready. ",
    auth_error_email_not_verified:
      "We've sent you an email link to activate your account.",
    auth_error_invalid_email_format: 'Invalid email format.',
    auth_error_invalid_grant: 'Invalid email or password.',
    auth_error_invalid_company: 'Please check company name',
    auth_error_invalid_user_password: 'Invalid email or password.',
    auth_error_no_name: 'Did you forget to fill in your name?',
    ...
    auth_error_password_too_short: 'Password should be at least 8 characters',
    auth_error_too_many_attempts:
      'Too many login attempts. We have sent instructions on how to proceed to your e-mail. ',
    auth_error_too_many_logins: 'Too many logins in a short time.',
    auth_error_unauthorized:
    ...
    auth_field_password_again: 'Password again',
    auth_field_company: 'Company',
    auth_login_cta: "Don't have an account yet? Sign up.",
    auth_login_forgot_password: 'Forgot your password?',
    auth_login_header: 'Log in to your account',
    auth_login_page_title: 'Login',
    auth_login_perex:
    ...
    auth_signup_gdpr:
      'By registering, you agree to the Privacy Statement and Privacy Policy.',
    auth_signup_header: 'Register',
    ...
    button_discover: 'explore innovation',
  ...
  en: {
    ...
    navbar_search_num_of_results: 'Number of results',
    navbar_search_results: 'search results',
    navbar_share_label: 'Share',
    navbar_share_link_copied: 'Link copied to clipboard',
    password: 'Password',
    photos: 'Photos',
    sidebar_about_innovation: 'About Innovation',
