module.exports = {
  cs: {
    ...
    auth_error_too_short_password: 'Heslo musí být delší než 8 znaků',
    ...
    auth_field_password_again: 'Potvrzení hesla',
    auth_field_phone: 'Telefon',
    auth_field_label_required: 'Povinná položka',
  ...
  de: {
    about_header: 'Über ŠKODA AUTO Logistik',
    ...
    auth_email_change_password_disclaimer:
      'Wenn Sie diese E-Mail ohne Ihr Wissen erhalten haben, kontaktieren Sie uns bitte.',
    auth_email_change_password_header: 'Ändern Sie Ihr Passwort',
    auth_email_change_password_instructions:
      'Klicken Sie auf den Link, um ein neues Passwort für Ihr Konto festzulegen.',
    auth_email_change_password_subject: 'Ändern Sie Ihr Passwort',
    auth_email_verification_disclaimer:
      'Wenn Sie diese E-Mail ohne Ihr Wissen erhalten haben, kontaktieren Sie uns bitte.',
    ...
    auth_email_verification_loading_header: 'Wir überprüfen Ihre E-Mail ...',
    auth_email_verification_page_title: 'Überprüfung Ihrer E-Mail',
    ...
    auth_error_no_name: 'Haben Sie vergessen, Ihren Namen einzugeben?',
    auth_error_password_lowercase: 'Foto',
    ...
    auth_error_too_many_attempts:
      'Zu viele Anmeldeversuche. Wir haben Anweisungen zum weiteren Vorgang auf Ihre E-Mail gesendet. ',
    ...
    auth_field_password_again: 'Passwortbestätigung',
    auth_field_phone: 'Telefon',
    auth_field_label_required: 'Pflichtfeld',
    auth_login_cta: 'Noch kein Konto? Melden Sie sich an.',
    ...
    button_discover: 'Innovationen entdecken',
  ...
  en: {
    ...
    auth_email_verification_loading_header: 'Verifying of your email ...',
    auth_email_verification_page_title: 'Verification of your email',
    ...
    auth_field_password_again: 'Password confirmation',
    auth_field_phone: 'Phone',
    auth_field_label_required: 'Required field',
